  ...
  return (
    <div className="relative flex min-h-full w-full flex-1 flex-col items-center justify-center font-sans">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative z-10 flex flex-col items-center justify-center bg-black/50 backdrop-blur-sm rounded-lg shadow-lg p-20 px-10 max-w-md border-2 border-slate-500">
        ...
        <h1 className="text-2xl font-light text-white mb-5 text-center font-geist-sans">
        ...
        <div className="flex flex-col items-center justify-center w-full mt-5">
          <input
            type="text"
            placeholder="Email"
            className="w-full p-2 rounded-md mb-2 border-2 border-slate-500 bg-slate-800/80 text-white"
          />
          <input
            type="password"
            placeholder="Contraseña"
            className="w-full p-2 rounded-md mb-3 border-2 border-slate-500 bg-slate-800/80 text-white"
          />
