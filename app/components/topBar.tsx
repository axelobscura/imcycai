    ...
    return (
      <div className="grid grid-cols-[2fr_10fr_1fr] fixed top-0 left-0 w-full">
        <div className="flex items-center justify-center p-2">
            <Link href="/" className="block flex items-center justify-center">
                <Image 
                    src="/logo-imcyc.svg" 
        ...
        <div 
            className="flex justify-center bg-slate-900 items-center p-2 rounded-tab-inverted w-full px-50"
            style={{
                boxShadow: "inset 0 0 10px 4px rgba(0, 0, 0, 0.5)",
            }}
        >
